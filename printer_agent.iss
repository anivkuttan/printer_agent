...
OutputDir=./dist/
OutputBaseFilename=Laundry_Printer_Agent_Installer-7.5.0
Compression=lzma
...
; -----------------------------------------------------------
[Files]
Source: "dist\laundry_printer_agent_7.5.0.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Root: HKCR; Subkey: "laundryagent\shell\open\command"; ValueType: string; ValueName: ""; \
    ValueData: """{app}\laundry_printer_agent_7.5.0.exe"" ""%1"""
...
Root: HKCU; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Run"; \
    ...
    ValueData: """{app}\laundry_printer_agent_7.5.0.exe"""; Flags: uninsdeletevalue

; -----------------------------------------------------------
; Shortcuts
; -----------------------------------------------------------
[Icons]
Name: "{group}\LAUNDRY Printer Agent"; Filename: "{app}\laundry_printer_agent_7.5.0.exe"
Name: "{commondesktop}\LAUNDRY Printer Agent"; Filename: "{app}\laundry_printer_agent_7.5.0.exe"
...
; -----------------------------------------------------------
[Run]
Filename: "{app}\laundry_printer_agent_7.5.0.exe"; \
